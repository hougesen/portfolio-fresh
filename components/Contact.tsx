        ...
        <section class={tw`pb-12 grid grid-cols-1 lg:grid-cols-2`}>
            <div class={tw`contact-text my-auto`}>
                ...
                <div class={tw`flex items-center gap-2 my-2`}>
                    ...
                    <a href='mailto:mads@mhouge.dk' class={tw`underline text-xl  text__flip`}>
                        mads@mhouge.dk
                    </a>
                </div>
                ...
                <div class={tw`flex items-center gap-2 mb-4`}>
                    ...
                    <p class={tw`text-xl  text__flip`}>Odense, Danmark</p>
                </div>
            ...
            <div class={tw`ml-auto hidden lg:block`}>
                <svg viewBox='0 0 629 605' xmlns='http://www.w3.org/2000/svg' class={tw`text__flip w-64 h-fit ml-auto`}>
                    <path
