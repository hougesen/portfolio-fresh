...
function Project({ project }: { project: IProject }) {
    return (
        <div class={tw`w-full bg-white p-4 flex flex-col border border-solid border-[#101010]`}>
            <div class={tw`flex`}>
...
export default function Projects({ projects }: { projects: IProject[] }) {
    return (
        <div>
            <h1 class={tw`uppercase text-4xl font-bold`}>Projects</h1>

            <div class={tw`grid grid-cols-1 md:grid-cols-3 gap-8`}>
